...
<p>프랑스가 사형제도 자체를 폐지한 건 1981년. 스타워즈 속편 제국의 역습이 나온 다음 해다.</p>`,
  },
  {
    ...
    category: "invention",
    date: "2026-03-17",
    summary: "하버드가 설립된 건 1636년이다. 뉴턴이 미적분을 정리한 프린키피아가 나온 건 1687년. 하버드가 51년 선배.",
    ...
    timeline: [
      ...
      { year: "1687년", label: "뉴턴, 프린키피아 출판", highlight: true },
    ],
    content: `<p>하버드 대학교 설립: 1636년. 뉴턴의 프린키피아(미적분이 정리된 책) 출판: 1687년. <strong>하버드가 51년 먼저다.</strong></p>
<p>그러니까 하버드 초기 학생들은 미적분 없이 공부한 거다. 미적분이 아직 세상에 존재하지 않았으니까.</p>
<blockquote>하버드가 이미 반세기 동안 학생을 가르치고 있을 때, 뉴턴은 아직 태어나지도 않았다.</blockquote>
<p>참고로 옥스퍼드는 1096년이다. 미적분보다 591년 선배. 대학이라는 제도가 수학보다 훨씬 오래됐다.</p>`,
  },
  {
