...
<p>역병이 닫은 문 뒤에서, 근대 과학의 토대가 만들어졌다.</p>`,
  },
  {
    ...
    title: "반 고흐는 생전에 유화를 딱 한 점 팔았다",
    category: "people",
    date: "2026-03-21",
    summary: "고흐 생전 유일하게 팔린 유화: '아를의 붉은 포도밭' (1890년, 400프랑). 드로잉은 몇 점 거래된 기록이 있다.",
    tags: ["반고흐", "화가", "생전", "유화한점", "아를"],
    relatedSlugs: ["gogh-eiffel-tower", "newton-gogh-not-contemporary"],
    timeline: [
      { year: "1853년", label: "고흐 출생" },
      { year: "1881년", label: "본격적으로 그림 시작" },
      { year: "1890년", label: "'아를의 붉은 포도밭' 유화 판매 (400프랑)", highlight: true },
      { year: "1890년 7월", label: "고흐 사망 (37세)", highlight: true },
      { year: "현재", label: "고흐 작품 경매가 수천억 원대" },
    ],
    content: `<p>고흐는 10년간 유화 약 900점, 드로잉 1,100점 이상을 남겼다.</p>
<p><strong>생전에 팔린 유화는 딱 한 점.</strong> '아를의 붉은 포도밭'. 1890년, 400프랑에 팔렸다. 드로잉은 몇 점 거래된 기록이 있다.</p>
