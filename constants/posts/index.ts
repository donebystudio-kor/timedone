...
<p>"고대"라는 한 단어 속에 숨어 있는 이 어마어마한 시간 차이, 한번 느껴보시면 역사가 조금 다르게 보일 거예요.</p>`,
  },
  {
    ...
    date: "2026-03-13",
    summary: "김정호가 전국을 걸어 다니며 지도를 만들 때, 바다 건너 런던에서는 세계 최초 지하철이 달리고 있었다.",
...
<p>1861년, 조선의 지리학자 김정호는 오랜 세월 전국 각지를 직접 돌아다니며 만든 역작 <strong>대동여지도</strong>를 완성합니다. 목판에 한 땀 한 땀 새긴 22첩의 지도, 당시 조선 최고의 기술력이었죠.</p>
...
<p>한쪽에서는 사람이 직접 걸어 다니며 산줄기와 물줄기를 종이에 그리고 있었고, 다른 한쪽에서는 사람들이 땅속으로 기차를 타고 출퇴근하고 있었어요. <strong>같은 지구, 같은 시대에요.</strong></p>
<blockquote>걸어서 지도를 만드는 나라와, 땅속으로 기차를 달리는 나라. 같은 해, 같은 지구.</blockquote>
